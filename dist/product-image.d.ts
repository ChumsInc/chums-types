export declare type ImageSizePath = '80' | '125' | '250' | '400' | '800' | '2048' | 'originals';
export interface ImageSize {
    width: number;
    height: number;
    size: number;
}
export declare type ImageSizeList = {
    [key in ImageSizePath]: ImageSize;
};
export declare type ColorSpaceList = {
    [key in ImageSizePath]: string;
};
export declare type ImageFormatList = {
    [key in ImageSizePath]: string;
};
